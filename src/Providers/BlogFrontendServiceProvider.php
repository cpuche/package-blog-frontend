...
namespace Cpuche\Blog\Frontend\Providers;
...
class BlogFrontendServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../config/blog-frontend.php' => config_path('blog-frontend.php'),
        // ], 'config');
         ...
         */
        // $this->loadTranslationsFrom(__DIR__.'/../../resources/lang', 'blog-frontend');
        // $this->loadJsonTranslationsFrom(__DIR__.'/../../resources/lang', 'blog-frontend');
        // $this->publishes([
        //     __DIR__.'/../../resources/lang' => resource_path('lang/vendor/blog-frontend'),
        // ], 'translations');
         ...
         */
        // $this->loadViewsFrom(__DIR__.'/../../resources/views', 'blog-frontend');
        // $this->publishes([
        //     __DIR__.'/../../resources/views' => resource_path('views/vendor/blog-frontend'),
        // ], 'views');
        ...
        //     $this->commands([
        //         \Cpuche\Blog\Frontend\Console\Commands\BlogFrontendCommand::class,
        //     ]);
        // }
         ...
         */
        // $this->publishes([
        //     __DIR__.'/../../public' => public_path('vendor/blog-frontend'),
        // ], 'public');
    ...
    public function register()
    {
        ...
        //     __DIR__.'/../../config/blog-frontend.php', 'blog-frontend'
        // );
    }
}
